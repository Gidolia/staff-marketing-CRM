...
$folder1 = "../../admin/ibo_panel/production/Documents/".$filename1;
move_uploaded_file($tempname1, $folder1);

$qry="UPDATE `market_employee` SET `profile`='$filename1' WHERE `e_id`='$_SESSION[id]'";
$res=$con->query($qry);
if($res===TRUE){
    echo "<script>alert('profile photo updated success');location.href='profileView.php';</script>";
}else{
    echo "<script>alert('profile photo updated Failed');location.href='change_profile_photo.php';</script>";
}
