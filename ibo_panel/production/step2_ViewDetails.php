            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                ...
                <tr>
                    ...
                    <td><a href="step1_ViewDetails.php?e_id=<?php echo $_GET[e_id]?>&cl_id=<?php echo $_GET[cl_id]?>"><button class="btn btn-info">View Details</button></a></td>
                </tr>
                <tr>
                    <td>Step.2(Call History)</td>
                     <td><a href="step2_ViewDetails.php?e_id=<?php echo $_GET[e_id]?>&cl_id=<?php echo $_GET[cl_id]?>"><button class="btn btn-info">View Details</button></a></td>
                </tr>
                <tr>
                    <td>Step.3(Work of Scope)</td>
                    <td><a href="step3_ViewDetails.php?e_id=<?php echo $_GET[e_id]?>&cl_id=<?php echo $_GET[cl_id]?>"><button class="btn btn-info">View Details</button></a></td>
                </tr>
                 <tr>
                    <td>Step.4</td>
