...
<html lang="en">
  <head>
    ...
    <title>EIBO Marketing | Step 1</title>
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                         ...
                         <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Upline Name<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                       ...
                       <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">Upline Number<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" class="form-control" name="up_no">
                        </div>
                      </div>
...
<?php
		  ...
		  {
			  $sql="INSERT INTO `employee_data_record`(`edr_id`, `cl_id`, `e_id`, `type`, `step_no`, `date`, `time`, `name`, `moble`, `email`, `address`, `city`, `state`, `upline_name`,`upline_no`) VALUES (NULL,'$_GET[cl_id]','$_GET[e_id]','data','1','$date','$time','$_POST[name]','$_POST[mobile]','$_POST[email]','$_POST[address]','$_POST[city]','$_POST[state]','$_POST[up_name]','$_POST[up_no]')";
			  if($con->query($sql) === TRUE)
			  {
				  echo "<script>alert('Step1 Completed Successfully');
    location.href='contact_list_detail.php?cl_id=$_GET[cl_id]';</script>";
			  }
			  else{
				  
				echo "<script>alert('Step 1  Failed');
    location.href='contact_list_detail.php?cl_id=$_GET[cl_id]';</script>";
			  }
		  }
