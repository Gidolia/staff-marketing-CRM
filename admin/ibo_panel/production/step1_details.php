          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Clients Information (step-1)</h3>
              </div>
            </div>
              ...
              <div class="col-md-12 col-sm-12 ">
                ...
                <tr>
                 ...
                 <tr>
                    <td>Action</td>
                    <td>
                    <a href="edit_step1_details.php?e_id=<?php echo $value[e_id]?>&cl_id=<?php echo $value[cl_id]?>"><button class="btn btn-primary">Edit</button></a>
